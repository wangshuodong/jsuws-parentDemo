...
public class ServiceStatusReqStruct  implements java.io.Serializable {
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ServiceStatusReqStruct)) return false;
        ServiceStatusReqStruct other = (ServiceStatusReqStruct) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ServiceStatusReqStruct.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://10.40.103.46:6482/NorthInterface/services/OperationDistributeService", "ServiceStatusReqStruct"));
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("ServiceStatusReqStruct{");
